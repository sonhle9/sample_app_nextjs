...
import {useReportDownloadUrl} from '../fees.queries';

export type FeeTransactionsReportDownloadProps = {
  generationId: string;
};

export const FeeTransactionsReportDownload = (props: FeeTransactionsReportDownloadProps) => {
      ...
      <Card className="max-w-xl mx-auto">
        <Card.Content>
          ...
          <div className="text-center">
            ...
            <p className="mb-5">{data ? `${data.data.fileName}` : 'Loading...'}</p>
