...
const ApprovedAdjustmentTransactionList: React.VFC = () => {
  ...
  const {data: resolvedData, isFetching} = useReportDataCustom({
    url: onDemandReportUrls.APPROVED_ADJUSTMENT_TRANSACTIONS,
  ...
  const {data: reportDetails} = useCardReportsDetails(
    ...
    onDemandReportUrls.APPROVED_ADJUSTMENT_TRANSACTIONS,
  );
    ...
    <>
      <div className="grid gap-4 pt-6 max-w-6xl mx-auto px-4 sm:px-6 mb-15 relative">
        <div className="flex justify-between">
          <h1 className={classes.h1}>Approved merchant adjustment transactions</h1>
          <Button
            variant="outline"
            onClick={() => {
            ...
            <>
              <DataTableRowGroup groupType="thead">
                <Tr>
                  ...
                  <Td>REFERENCE</Td>
                  <Td>ASSIGNMENT</Td>
                  <Td className="text-right">ADJUSTMENT TARGET</Td>
                </Tr>
              </DataTableRowGroup>
