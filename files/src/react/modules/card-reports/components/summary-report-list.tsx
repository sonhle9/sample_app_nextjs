...
const folderName = 'gift_card_summary_report';

const SummaryReportList: React.VFC = () => {
    ...
    <HasPermission accessWith={[cardReportAccess.view]}>
      <div className="grid gap-4 pt-6 max-w-6xl mx-auto px-4 sm:px-6 mb-15 relative">
        <div className="flex justify-between">
          <h1 className={classes.h1}>Gift card summary report</h1>
        </div>
        <Card className="mb-4">
                ...
                <Tr key={i}>
                  ...
                  <Td className="text-right">
                    <HasPermission accessWith={[cardReportAccess.download]}>
                      <a
                        download
                        className="text-brand-500 font-bold text-xs"
