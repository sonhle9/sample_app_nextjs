...
import {ExternalOrdersBulkUpdate} from 'src/react/modules/external-orders';
import {BridgeComponent} from 'src/shared/interfaces/bridge-component.interface';

@Component({
  template: '<div #container [appBreadcrumbs]="breadcrumbs"></div>',
})
export class ExternalOrdersBulkUpdateComponent implements BridgeComponent {
