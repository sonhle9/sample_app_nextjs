...
import {PaymentChargesListing} from 'src/react/modules/payments-charges';
import {BridgeComponent} from 'src/shared/interfaces/bridge-component.interface';

@Component({
  template: '<div #container [appBreadcrumbs]="breadcrumbs"></div>',
})
export class PaymentsChargesListingComponent implements BridgeComponent {
