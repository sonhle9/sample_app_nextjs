...
import {SmartpayAccountDetails} from '../../../../react/modules/merchants/components/smartpay-account/smartpay-account-details';

@Component({
  template: '<div #container [appBreadcrumbs]="breadcrumbs"></div>',
})
export class SmartpayAccountDetailsComponent implements AfterViewInit, OnDestroy {
    ...
    if (this.wrapper && this.wrapper.nativeElement) {
      ReactDOM.render(
        <ReactAdapterProvider adapterService={this.adapter} activatedRoute={this.route}>
          <SmartpayAccountDetails id={this.route.snapshot.paramMap.get('merchantId')} />
