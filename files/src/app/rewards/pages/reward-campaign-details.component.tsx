...
import {RewardCampaignDetails} from 'src/react/modules/reward-campaign';
import {BridgeComponent} from 'src/shared/interfaces/bridge-component.interface';

@Component({
  template: '<div #container [appBreadcrumbs]="breadcrumbs"></div>',
})
export class RewardCampaignDetailsComponent implements BridgeComponent {
  ...
  breadcrumbs: BreadcrumbItem[] = [
    ...
    },
    {
      ...
      to: '/rewards/rewards-campaigns',
    },
    {
      label: 'Reward campaign details',
    },
  ];
    ...
    if (this.wrapper && this.wrapper.nativeElement) {
      ReactDOM.render(
        <ReactAdapterProvider adapterService={this.adapter} activatedRoute={this.activatedRoute}>
          <RewardCampaignDetails id={this.activatedRoute.snapshot.paramMap.get('id')} />
