...
import {PaymentRefundsListing} from 'src/react/modules/payment-refunds';
import {BridgeComponent} from 'src/shared/interfaces/bridge-component.interface';

@Component({
  template: '<div #container [appBreadcrumbs]="breadcrumbs"></div>',
})
export class PaymentsRefundsListingComponent implements BridgeComponent {
