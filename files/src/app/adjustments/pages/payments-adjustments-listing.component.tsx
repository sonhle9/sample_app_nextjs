...
import {PaymentsAdjustmentsListing} from 'src/react/modules/payments-adjustments';
import {BridgeComponent} from 'src/shared/interfaces/bridge-component.interface';

@Component({
  template: '<div #container [appBreadcrumbs]="breadcrumbs"></div>',
})
export class PaymentsAdjustmentsListingComponent implements BridgeComponent {
