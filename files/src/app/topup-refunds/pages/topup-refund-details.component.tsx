...
import {TopupRefundDetails} from 'src/react/modules/topup-refund';
import {BridgeComponent} from 'src/shared/interfaces/bridge-component.interface';

@Component({
  template: '<div #container [appBreadcrumbs]="breadcrumbs"></div>',
})
export class TopupRefundDetailsComponent implements BridgeComponent {
  ...
  breadcrumbs: BreadcrumbItem[] = [
    ...
    },
    {
      ...
      to: '/wallet/topup-refunds/listing',
    },
    {
    ...
    if (this.wrapper && this.wrapper.nativeElement) {
      ReactDOM.render(
        <ReactAdapterProvider adapterService={this.adapter} activatedRoute={this.activatedRoute}>
          <TopupRefundDetails id={this.activatedRoute.snapshot.paramMap.get('id')} />
