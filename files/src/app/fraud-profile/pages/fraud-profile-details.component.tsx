...
import {FraudProfileDetails} from 'src/react/modules/fraud-profile';
import {BridgeComponent} from 'src/shared/interfaces/bridge-component.interface';

@Component({
  template: '<div #container [appBreadcrumbs]="breadcrumbs"></div>',
})
export class FraudProfileDetailsComponent implements BridgeComponent {
  ...
  breadcrumbs: BreadcrumbItem[] = [
    ...
    },
    {
      ...
      to: '/risk-controls/fraud-profiles/listing',
    },
    {
      label: 'Fraud profile details',
    },
  ];
    ...
    if (this.wrapper && this.wrapper.nativeElement) {
      ReactDOM.render(
        <ReactAdapterProvider adapterService={this.adapter} activatedRoute={this.activatedRoute}>
          <FraudProfileDetails id={this.activatedRoute.snapshot.paramMap.get('id')} />
