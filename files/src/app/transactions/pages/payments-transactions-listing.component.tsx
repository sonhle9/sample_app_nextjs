...
import {PaymentsTransactionsListing} from 'src/react/modules/payments-transactions';
import {BridgeComponent} from 'src/shared/interfaces/bridge-component.interface';

@Component({
  template: '<div #container [appBreadcrumbs]="breadcrumbs"></div>',
})
export class PaymentsTransactionsListingComponent implements BridgeComponent {
