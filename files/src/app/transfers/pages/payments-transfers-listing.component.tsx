...
import {PaymentsTransfersListing} from 'src/react/modules/payments-transfers';
import {BridgeComponent} from 'src/shared/interfaces/bridge-component.interface';

@Component({
  template: '<div #container [appBreadcrumbs]="breadcrumbs"></div>',
})
export class PaymentsTransfersListingComponent implements BridgeComponent {
