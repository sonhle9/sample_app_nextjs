...
@Component({
  moduleId: module.id,
  selector: 'app-customer-topups',
  templateUrl: 'customerTopups.html',
  styleUrls: ['customerTopups.scss'],
})
export class CustomerTopupsComponent implements OnChanges, OnDestroy {
  @Input()
  customerId;
  ...
  indexTransactions() {
    ...
    this.apiCustomersService
      .indexCustomerTransactions(this.customerId, this.pagination.index, this.pagination.page, [
        'topup',
        'refund',
      ])
