...
@Component({
  selector: 'app-merchant-search-select',
  templateUrl: './merchant-search-select.html',
  styleUrls: ['./merchant-search-select.scss'],
})
export class MerchantSearchSelectComponent implements OnInit, OnDestroy {
